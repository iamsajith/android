	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				s.setClass(getApplicationContext(), ResultsActivity.class);
				startActivity(s);
			}
		});
		...
		button1.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				s.setClass(getApplicationContext(), AlertActivity.class);
				startActivity(s);
			}
		});
		...
		button2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				s.setClass(getApplicationContext(), CircularsActivity.class);
				startActivity(s);
			}
		});
		...
		button3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				s.setClass(getApplicationContext(), ImpdatesActivity.class);
				startActivity(s);
			}
		});
